...
#include <shape_registration/shape_registration_service.hpp>

#include <ros/package.h>

using namespace categorical_registration;

ShapeRegistrationService::ShapeRegistrationService()
{
...
/* void ShapeRegistrationService::addTrainingInstance(const std::string filepath)
{
...
/* void ShapeRegistrationService::addTestingObserved(const std::string filepath)
{
	if (filepath.substr(filepath.find_last_of(".") + 1) == "ply")
	// Meshes are loaded
	{
...
void ShapeRegistrationService::setTestingObserved(PointCloudT::Ptr cloud)
{
...
/* void ShapeRegistrationService::setCanonicalMeshIdx(int idx)
{
...
void ShapeRegistrationService::setCanonicalPCDIdx(int idx)
{
...
/* void ShapeRegistrationService::setObservedMeshIdx(int idx)
{
...
void ShapeRegistrationService::setObservedPCDIdx(int idx)
{
...
/* void ShapeRegistrationService::deleteMesh(const int idx)
{
...
void ShapeRegistrationService::deletePCD(const int idx)
{
...
/* void ShapeRegistrationService::updateViewer()
{
	if (m_training_view)
	{
			m_viewer.updateClouds();
...
void ShapeRegistrationService::calculateDeformationFields()
{
	m_CPD_done = false;
...
void ShapeRegistrationService::cpd(int can_number, int obs_number)
{
...
void ShapeRegistrationService::cpdOnClouds(int can_number, int obs_number)
{
...
/* void ShapeRegistrationService::cpdOnMeshes(int can_number, int obs_number)
{
	// Just to inform about the progress
	int calculationNumber = obs_number + 1;
...
bool ShapeRegistrationService::doPCA(int n_latent)
{
...
void ShapeRegistrationService::buildBigW()
{
	if ( !m_using_meshes && !m_cloudData.getCpdDone() )
	{
...
void ShapeRegistrationService::setSlider(int value)
{
...
void ShapeRegistrationService::visualizePCA()
{
...
MatrixXd ShapeRegistrationService::wFromClassW(int index, MatrixXd bigW)
{
...
void ShapeRegistrationService::saveCPD()
{
...
void ShapeRegistrationService::loadCPD()
{
...
void ShapeRegistrationService::buildFromCPD()
{
...
/* void ShapeRegistrationService::buildMeshesFromCPD()
{
	if (false) 
...
void ShapeRegistrationService::buildCloudsFromCPD()
{
	if (false)
...
MatrixXd ShapeRegistrationService::pointsInLatentSpace()
{
	pca::ptr calculatedPca;
...
void ShapeRegistrationService::clear()
{
...
void ShapeRegistrationService::fitToObserved()
{
	if (!m_using_meshes)
	{
...
void ShapeRegistrationService::cancelFitting()
{
	emit haltOpt();
}


MatrixXd ShapeRegistrationService::getModelFromLatent(const MatrixXd& latent, const Eigen::Affine3d& trans)
{
...
MatrixXd ShapeRegistrationService::getModelFromLatent(const MatrixXd& latent, double *pose)
{
...
void ShapeRegistrationService::fitted(const MatrixXd& latent, const Eigen::Affine3d& trans)
{
...
void ShapeRegistrationService::plotCallback()
{
}


void ShapeRegistrationService::modelCallback(double *latent, double *pose)
{
